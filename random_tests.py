...
# import json
# import requests
# from src.utils import sort_list_of_vacancies_by_pay
...
# # if __name__ == "__main__":
# #     a = HHManagerJSON()
# #     a.delete_vacancy_by_id("99701439")
#
# # if __name__ == "__main__":
# #     get_vac = HHVacancyGetter('Python')
# #     a = get_vac.get_vacancies()
...
# #         data = json.load(file)
# #
# #         list_ = sort_list_of_vacancies_by_pay(data)
# #
# #         print(len(list_))
# #
# #         for i in list_:
...
# #
# #
# #         !!! нужно убрать из vacancy использование requests и
# #             что-то придумать с description
#
# if __name__ == "__main__":
#     user_interface()
